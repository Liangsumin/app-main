...
public class TitleBar extends ViewGroup implements View.OnClickListener, HasTypeface {
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mSideTextColor = Color.parseColor("#1F1F1F");
        ...
        mTitleTextColor = Color.parseColor("#1F1F1F");
        ...
        mSubTitleTextColor = Color.parseColor("#1F1F1F");
        ...
        mActionTextColor = Color.parseColor("#1F1F1F");
        ...
        mIsUseThemeColor = typedArray.getBoolean(R.styleable.TitleBar_tb_useThemeColor, false);
        mIsUseThemeColor = false;
...
//            }
//            setBackgroundColor(R.attr.xui_actionbar_color);
//        }
    }
