 ...
 */
public class AllKnowledge extends BaseFragment {
            ...
            HttpUtil.sendHttpRequest(comurl, new HttpCallbackListener() {
                ...
                public String onFinish(String response) {
                    ...
                    runOnUiThread(() -> {
                        ...
                        mAdapter.setOnItemClickListener((itemView, item, position) -> openNewPage(Knowledge_specific.class,"id",item.getDetailUrl()));
