...
@Page(name = "短语集")
public class Phrase_specific extends BaseFragment {
    ...
    protected void initData(String content) {
        ...
        if (data != null) {
            ...
            for (int i=0; i<contents.size(); i++) {
                ...
                dataModel.Content = contents.getString(i);
    ...
    protected void initListeners() {
        ...
        new ViewLikeUtils(g_icon, textView, (view, toggle, viewLikeUtils) -> {
            if (IS_GOOD && popupWindow != null && !popupWindow.isShowing()) {
        ...
        new ViewLikeUtils(f_icon, textView, (view, toggle, viewLikeUtils) -> {
            if (IS_FAVOR && popupWindow != null && !popupWindow.isShowing()) {
    ...
    private void initPopupWindow() {
        //要在布局中显示的布局
        contentView = LayoutInflater.from(getContext()).inflate(R.layout.popupwindow_layout_delete, null, false);
        //实例化PopupWindow并设置宽高
...
//        popupWindow.setAnimationStyle(R.style.MyPopWindowAnim);
    ...
    public void showPopWindow(String content) {
        View rootview = LayoutInflater.from(getContext()).inflate(R.layout.popupwindow_layout_delete, null);
        ...
        delete = popupWindow.getContentView().findViewById(R.id.delete);
