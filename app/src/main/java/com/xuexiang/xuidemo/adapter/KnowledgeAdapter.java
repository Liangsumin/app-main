...
public class KnowledgeAdapter extends ArrayAdapter<KnowledgeData> {

    public KnowledgeAdapter(@NonNull Context context, int resource, @NonNull List<KnowledgeData> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        view.setOnClickListener(v -> {
            ...
            baseFragment.openNewPage(Knowledge_specific.class,"id",data.id);
        });
